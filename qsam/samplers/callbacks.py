# AUTOGENERATED! DO NOT EDIT! File to edit: 05c_samplers.callbacks.ipynb (unless otherwise specified).
...
class PlotStats(Callback):
    ...
    def on_sampler_end(self, sampler):
        p_L_low, std, delta, delta_std = sampler.stats()
...
class RelStdTarget(Callback):
    ...
    def on_sample_end(self, sampler):
        if hasattr(sampler, 'p_idx'):
            p_L, std, delta, _ = sampler.stats(p_idx=sampler.p_idx)
        else:
