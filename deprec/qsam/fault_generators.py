...
# Cell
from .datatypes.circuit import Circuit, partition, unpack
import numpy as np
...
class FaultGenerator:
    ...
    def faults_from_probs(self, ps, c_hash=None):
        ...
        partition_faults = [[loc for loc in locs if np.random.random() < p] for locs, p in zip(partitions, ps)]
        w_vec = tuple(len(l) for l in partition_faults)
        faults = [loc for partition in partition_faults for loc in partition]
        return w_vec, faults
