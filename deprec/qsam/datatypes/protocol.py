# AUTOGENERATED! DO NOT EDIT! File to edit: 01b_datatypes.protocol.ipynb (unless otherwise specified).

__all__ = ['Protocol', 'iterate', 'save_protocol', 'load_protocol']
...
class Protocol(nx.DiGraph):
    ...
    def draw(self, save_path=None, figsize=(6,4), layout=nx.kamada_kawai_layout, edge_legend=False, self_loop_offset=(0.03,0.06), color=True):
