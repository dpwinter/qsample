  ...
  'syms': { 'qsample.callbacks': { 'qsample.callbacks.Callback': ('callbacks.html#callback', 'qsample/callbacks.py'),
            ...
            'qsample.sampler.tree': { 'qsample.sampler.tree.Constant': ('sampler.tree.html#constant', 'qsample/sampler/tree.py'),
                                      ...
                                      'qsample.sampler.tree.CountTree.__init__': ( 'sampler.tree.html#counttree.__init__',
                                                                                   'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.CountTree.__is_invariant_path': ( 'sampler.tree.html#counttree.__is_invariant_path',
                                                                                              'qsample/sampler/tree.py'),
                                      ...
                                      'qsample.sampler.tree.Variable.variance': ( 'sampler.tree.html#variable.variance',
                                                                                  'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.count_tree_to_dict': ( 'sampler.tree.html#count_tree_to_dict',
                                                                                   'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.dict_to_count_tree': ( 'sampler.tree.html#dict_to_count_tree',
                                                                                   'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.draw_tree': ('sampler.tree.html#draw_tree', 'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.iter_node_attr': ( 'sampler.tree.html#iter_node_attr',
                                                                               'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.load': ('sampler.tree.html#load', 'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.rec_node_tree_from_dict': ( 'sampler.tree.html#rec_node_tree_from_dict',
                                                                                        'qsample/sampler/tree.py'),
                                      'qsample.sampler.tree.rec_node_tree_to_dict': ( 'sampler.tree.html#rec_node_tree_to_dict',
                                                                                      'qsample/sampler/tree.py')},
